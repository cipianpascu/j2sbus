...
import com.ciprianpascu.j2sbus.modbus.io.ModbusTCPTransaction;
import com.ciprianpascu.j2sbus.modbus.io.ModbusTransaction;
import com.ciprianpascu.j2sbus.modbus.msg.*;
import com.ciprianpascu.j2sbus.modbus.msg.ReadFileRecordRequest.RecordRequest;
import com.ciprianpascu.j2sbus.modbus.msg.ReadFileRecordResponse.RecordResponse;
import com.ciprianpascu.j2sbus.modbus.net.TCPMasterConnection;
...
public class TCPWriteRecordTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TCPWriteRecordTest.class);

    /**
     * usage -- Print command line arguments and exit.
     */
    private static void usage() {
        System.out.printf("Usage: TCPWriteRecordTest address[:port[:unit]] file record registers [count]");
            ...
            for (int i = 0; i < requestCount; i++) {
                ...
                if (dummy instanceof ExceptionResponse) {
                    ...
                    for (int j = 0; j < count; j++) {
                        ...
                        System.out.printf("read data[%d] = %s", j, Arrays.toString(values));
