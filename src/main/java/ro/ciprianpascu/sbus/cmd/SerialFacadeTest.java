...
import ro.ciprianpascu.sbus.facade.ModbusSerialMaster;
...
public class SerialFacadeTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("ro.ciprianpascu.sbus.debug set to: " + System.getProperty("ro.ciprianpascu.sbus.debug"));
    ...
    private static void printUsage() {
        System.out.println("java ro.ciprianpascu.sbus.cmd.SerialAITest <portname [String]>  <Unit Address [int8]>");
    }// printUsage
}
