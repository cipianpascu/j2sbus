...
import com.ciprianpascu.j2sbus.modbus.facade.ModbusSerialMaster;
...
import com.ciprianpascu.j2sbus.modbus.procimg.InputRegister;
...
public class TestModbusSerialRTUMasterRead extends AbstractTestModbusSerialRTUMaster {
    ...
    public void testBadUnitIdRequest() {
        try {
            master.readCoils(SUBNET_ID, UNIT_ID + 10, 0, 1);
    ...
    public void testBadCommsPortNotConnected() {
        ...
        try {
            master.connect();
            master.readInputRegisters(SUBNET_ID, UNIT_ID, 0, 5);
    ...
    public void testCallback() {
        ...
        try {
            master.readCoils(SUBNET_ID, UNIT_ID, 0, 1);
        }
        catch (Exception e) {
            fail(String.format("Cannot read - %s", e.getMessage()));
        }
