...
import com.ciprianpascu.modbus.facade.ModbusSerialMaster;
...
import com.ciprianpascu.modbus.util.ModbusUtil;
...
public class SerialFacadeTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("com.ciprianpascu.modbus.debug set to: " + System.getProperty("com.ciprianpascu.modbus.debug"));
    ...
    private static void printUsage() {
        System.out.println("java com.ciprianpascu.modbus.cmd.SerialAITest <portname [String]>  <Unit Address [int8]>");
    }// printUsage
}
