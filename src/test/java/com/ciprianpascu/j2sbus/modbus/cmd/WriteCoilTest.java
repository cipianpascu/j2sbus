...
import com.ciprianpascu.j2sbus.modbus.msg.WriteCoilResponse;
...
public class WriteCoilTest {
    ...
    private static void printUsage() {
        System.out.printf("\nUsage:\n    java com.ciprianpascu.j2sbus.modbus.cmd.WriteCoilTest <connection [String]> <unit [int8]> <coil [int16]> <state [boolean]> {<repeat [int]>}");
    }
