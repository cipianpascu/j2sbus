...
package ro.ciprianpascu.modbus.net;
...
import ro.ciprianpascu.modbus.io.ModbusASCIITransport;
import ro.ciprianpascu.modbus.io.ModbusBINTransport;
import ro.ciprianpascu.modbus.io.ModbusRTUTransport;
import ro.ciprianpascu.modbus.io.ModbusSerialTransport;
import ro.ciprianpascu.modbus.io.ModbusTransport;
...
public class SerialConnection implements SerialPortEventListener, ModbusSlaveConnection {
    ...
    protected void setConnectionParameters() throws Exception {
        ...
        // to original state.
        try {
            m_SerialPort.setSerialPortParams(m_Parameters.getBaudRate(), m_Parameters.getDatabits(),
                    m_Parameters.getStopbits(), m_Parameters.getParity());
        } catch (UnsupportedCommOperationException e) {
