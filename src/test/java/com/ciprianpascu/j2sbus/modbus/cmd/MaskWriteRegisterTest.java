...
import com.ciprianpascu.j2sbus.modbus.msg.MaskWriteRegisterRequest;
...
public class MaskWriteRegisterTest {
    ...
    private static void printUsage() {
        System.out.printf("\nUsage:\n    java com.ciprianpascu.j2sbus.modbus.cmd.WriteHoldingRegisterTest <address{:<port>{:<unit>}} [String]> <register [int]> <andMask [int]> <orMask [int]> {<repeat [int]>}");
    }
