...
import com.ciprianpascu.j2sbus.modbus.msg.WriteCoilRequest;
...
public class DIDOTest {
    ...
    private static void printUsage() {
        System.out.printf("\nUsage:\n    java com.ciprianpascu.j2sbus.modbus.cmd.DIDOTest <address{:<port>} [String]> <register d_in [int16]> <register d_out [int16]>");
    }
}
