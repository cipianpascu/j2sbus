...
import com.ciprianpascu.j2sbus.modbus.io.*;
...
public class ReadInputRegistersTest {
    ...
    private static void printUsage() {
        System.out.printf("\nUsage:\n    java com.ciprianpascu.j2sbus.modbus.cmd.ReadInputRegistersTest <address{:port{:unit}} [String]> <base [int]> <count [int]> {<repeat [int]>}");
    }
