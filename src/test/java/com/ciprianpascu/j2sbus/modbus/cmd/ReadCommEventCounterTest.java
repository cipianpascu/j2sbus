...
public class ReadCommEventCounterTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ReadCommEventCounterTest.class);

    private static void printUsage() {
        System.out.printf("\nUsage:\n    java com.ciprianpascu.j2sbus.modbus.cmd.ReadCommEventCounterTest <address{:port} [String]> <unit [int]> {<repeat [int]>}");
    }
