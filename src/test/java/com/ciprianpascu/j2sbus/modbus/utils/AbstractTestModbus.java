...
import com.ciprianpascu.j2sbus.modbus.procimg.*;
import com.ciprianpascu.j2sbus.modbus.procimg.Record;
import com.ciprianpascu.j2sbus.modbus.slave.ModbusSlave;
import com.ciprianpascu.j2sbus.modbus.util.Observable;
import com.ciprianpascu.j2sbus.modbus.util.Observer;
...
public class AbstractTestModbus {
    ...
    protected static SimpleProcessImage getSimpleProcessImage() {
        ...
        // A couple of files
        spi.addFile(new com.ciprianpascu.j2sbus.modbus.procimg.File(0, 10)
        ...
        spi.addFile(new com.ciprianpascu.j2sbus.modbus.procimg.File(1, 20)
                .setRecord(0, new Record(0, 10))
