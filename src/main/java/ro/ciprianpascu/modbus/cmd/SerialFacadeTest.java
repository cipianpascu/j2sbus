...
import ro.ciprianpascu.modbus.facade.ModbusSerialMaster;
...
import ro.ciprianpascu.modbus.util.ModbusUtil;
...
public class SerialFacadeTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            do {
                if (msm.writeCoil(subnetId, slaveId, 4, true) == true) {
    ...
    private static void printUsage() {
        System.out.println("java ro.ciprianpascu.modbus.cmd.SerialAITest <portname [String]>  <Unit Address [int8]>");
    }// printUsage
}
