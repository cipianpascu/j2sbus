...
import ro.ciprianpascu.modbus.io.ModbusTransaction;
import ro.ciprianpascu.modbus.msg.ModbusRequest;
...
import ro.ciprianpascu.modbus.procimg.SimpleRegister;
...
public class AIAOTest {
    ...
    private static void printUsage() {
        System.out.println(
                "java ro.ciprianpascu.modbus.cmd.AIAOTest <address{:<port>} [String]> <register a_in [int16]> <register a_out [int16]>");
    }// printUsage
