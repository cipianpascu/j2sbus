...
/**
 * Class implementing a specialized {@link OutputStream} which
 ...
 * @version %I% (%G%)
 * @see ro.ciprianpascu.sbus.io.ModbusASCIITransport#FRAME_START
 * @see ro.ciprianpascu.sbus.io.ModbusASCIITransport#FRAME_END
 * @see ro.ciprianpascu.sbus.io.ModbusASCIITransport#FRAME_START
 * @see ro.ciprianpascu.sbus.io.ModbusASCIITransport#FRAME_END
 */
public class ASCIIOutputStream extends FilterOutputStream {
    ...
    /**
     * Constructs a new {@link ASCIIOutputStream} instance
     ...
     *
     * @param b the byte to be written as {@link int}.
     ...
     *
     * @param data the {@link byte[]} to be written.
     * @throws IOException if an I/O error occurs.
     */
    @Override
