...
package ro.ciprianpascu.modbus.facade;

import ro.ciprianpascu.modbus.ModbusCoupler;
import ro.ciprianpascu.modbus.ModbusException;
import ro.ciprianpascu.modbus.io.ModbusSerialTransaction;
import ro.ciprianpascu.modbus.msg.ReadCoilsRequest;
import ro.ciprianpascu.modbus.msg.ReadCoilsResponse;
import ro.ciprianpascu.modbus.msg.ReadInputDiscretesRequest;
import ro.ciprianpascu.modbus.msg.ReadInputDiscretesResponse;
import ro.ciprianpascu.modbus.msg.ReadInputRegistersRequest;
import ro.ciprianpascu.modbus.msg.ReadInputRegistersResponse;
import ro.ciprianpascu.modbus.msg.ReadMultipleRegistersRequest;
import ro.ciprianpascu.modbus.msg.ReadMultipleRegistersResponse;
import ro.ciprianpascu.modbus.msg.WriteCoilRequest;
import ro.ciprianpascu.modbus.msg.WriteCoilResponse;
import ro.ciprianpascu.modbus.msg.WriteMultipleCoilsRequest;
import ro.ciprianpascu.modbus.msg.WriteMultipleRegistersRequest;
import ro.ciprianpascu.modbus.msg.WriteSingleRegisterRequest;
import ro.ciprianpascu.modbus.net.SerialConnection;
import ro.ciprianpascu.modbus.procimg.InputRegister;
import ro.ciprianpascu.modbus.procimg.Register;
import ro.ciprianpascu.modbus.util.BitVector;
import ro.ciprianpascu.modbus.util.SerialParameters;
...
public class ModbusSerialMaster {
    ...
    public synchronized BitVector readCoils(int subnetid, int unitid, int ref, int count) throws ModbusException {
    	m_ReadCoilsRequest.setSubnetID(subnetid);
    ...
    public synchronized void writeMultipleCoils(int subnetid, int unitid, int ref, BitVector coils) throws ModbusException {
    	m_WriteMultipleCoilsRequest.setSubnetID(subnetid);
    ...
    public synchronized BitVector readInputDiscretes(int subnetid, int unitid, int ref, int count) throws ModbusException {
    	m_ReadInputDiscretesRequest.setSubnetID(subnetid);
    ...
    public synchronized InputRegister[] readInputRegisters(int subnetid, int unitid, int ref, int count) throws ModbusException {
    	m_ReadInputRegistersRequest.setSubnetID(subnetid);
    ...
    public synchronized Register[] readMultipleRegisters(int subnetid, int unitid, int ref, int count) throws ModbusException {
    	m_ReadMultipleRegistersRequest.setSubnetID(subnetid);
     ...
     *             a transaction error occurs.
     */
    public synchronized void writeSingleRegister(int subnetid, int unitid, int ref, Register register) throws ModbusException {
    	m_WriteSingleRegisterRequest.setSubnetID(subnetid);
     ...
     *             a transaction error occurs.
     */
    public synchronized void writeMultipleRegisters(int subnetid, int unitid, int ref, Register[] registers) throws ModbusException {
    	m_WriteMultipleRegistersRequest.setSubnetID(subnetid);
