...
public class ModbusTCPListener implements Runnable {
     ...
     *
     * @param poolsize the size of the {@link ThreadPool} used to handle
     *            incoming requests.
    ...
    /**
     * Starts this {@link ModbusTCPListener}.
     */
    public void start() {
    ...
    /**
     * Stops this {@link ModbusTCPListener}.
     */
    public void stop() {
        m_Listening = false;
        try {
     ...
     * {@link TCPConnectionHandler} instances.
     */
    @Override
    public void run() {
        try {
