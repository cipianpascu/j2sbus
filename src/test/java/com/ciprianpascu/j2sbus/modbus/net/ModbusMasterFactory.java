...
import com.ciprianpascu.j2sbus.modbus.io.ModbusRTUTransport;
...
import com.ciprianpascu.j2sbus.modbus.net.UDPMasterTerminal;
...
public class ModbusMasterFactory {
    ...
    private static AbstractModbusTransport createCustomModbusMaster(String address, AbstractSerialConnection serialConnection) {
        ...
        int baudRate = 9600;
        if (System.getProperty("com.ciprianpascu.j2sbus.modbus.baud") != null) {
            baudRate = Integer.parseInt(System.getProperty("com.ciprianpascu.j2sbus.modbus.baud"));
        }
