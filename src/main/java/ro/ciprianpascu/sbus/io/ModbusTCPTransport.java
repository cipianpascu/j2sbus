...
public class ModbusTCPTransport implements ModbusTransport {
     ...
     * for a given {@link Socket}.
* 
     *
     * @param socket the {@link Socket} used for message transport.
     */
    ...
    /**
     * Sets the {@link Socket} used for message transport and
     ...
     * {@link ModbusTCPTransport} instance based on the given
     * socket.
     *
