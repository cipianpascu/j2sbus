...
import com.ciprianpascu.modbus.io.ModbusTransaction;
...
public class AIAOTest {
    ...
    private static void printUsage() {
        System.out.println(
                "java com.ciprianpascu.modbus.cmd.AIAOTest <address{:<port>} [String]> <register a_in [int16]> <register a_out [int16]>");
    }// printUsage
