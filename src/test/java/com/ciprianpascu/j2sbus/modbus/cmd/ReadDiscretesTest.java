...
import com.ciprianpascu.j2sbus.modbus.msg.ReadInputDiscretesRequest;
import com.ciprianpascu.j2sbus.modbus.msg.ReadInputDiscretesResponse;
...
public class ReadDiscretesTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ReadDiscretesTest.class);

    private static void printUsage() {
        System.out.printf("\nUsage:\n    java com.ciprianpascu.j2sbus.modbus.cmd.ReadDiscretesTest <connection [String]> <unit [int8]> <register [int16]> <bitcount [int16]> {<repeat [int]>}");
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            do {
                ...
                System.out.printf("Input Discretes Status=%s", res.getDiscretes().toString());
