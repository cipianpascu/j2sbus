...
import ro.ciprianpascu.sbus.procimg.DigitalOut;
...
/**
 * Class implementing a {@link WriteMultipleCoilsRequest}.
...
public final class WriteMultipleCoilsRequest extends ModbusRequest {
    ...
    /**
     * Constructs a new {@link WriteMultipleCoilsRequest}
     * instance.
     */
     ...
     * from with this {@link ReadCoilsRequest}.
     * 
     *
     ...
     * reading from with this {@link ReadCoilsRequest}.
     * 
     *
    ...
    /**
     * Returns the {@link BitVector} instance holding coil
     * status information.
     *
     * @return the coils status as {@link BitVector} instance.
     */
    ...
    /**
     * Sets the {@link BitVector} instance holding coil
     * status information.
     *
     * @param bv a {@link BitVector} instance holding coil status info.
     */
