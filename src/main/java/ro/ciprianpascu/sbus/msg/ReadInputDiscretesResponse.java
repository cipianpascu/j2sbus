...
/**
 * Class implementing a {@link ReadInputDiscretesResponse}.
...
public final class ReadInputDiscretesResponse extends ModbusResponse {
    ...
    /**
     * Constructs a new {@link ReadInputDiscretesResponse}
     * instance.
     */
...
* 
    ...
    /**
     * Returns the {@link BitVector} that stores
     * the collection of bits that have been read.
* 
     *
     * @return the {@link BitVector} holding the
